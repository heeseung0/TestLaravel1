...
<head>
    ...
    <link rel="stylesheet" href="/css/baseinfo/warehouse.css">
    <link rel="stylesheet" href="/jqGrid-master/css/ui.jqgrid.css">
    <script type="text/javascript" src="/js/baseinfo/warehouse.js"></script>
...
<div class="container">
    <div class="top">
        ...
        <div class="options">
            ...
            <div class="option">
                <label class="option-label" style="display:inline-block">이름</label><input id="input_name" type="text" class="option-col-3">
            </div>
            <br>
            <div class="option">
