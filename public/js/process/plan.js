let searchResultColNames = [
    '관리','id','등록일','계획일자','품목코드','품목명','단위','계획수량','현재고'
];
let searchResultColModel = [
    ...
    {name: 'end_at',        index:'end_at',         align:'center', width:'50', editable:true,
        // select date
    ...
    {name: 'stock',      index:'stock',    align:'center', width:'50', editable:false,},
]
